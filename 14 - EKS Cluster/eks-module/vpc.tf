...
resource "aws_subnet" "public" {
  ...
  cidr_block        = cidrsubnet(var.vpc_cidr, var.subnet_cidr_bits, count.index) # cidrsubnet calculates a subnet address within given IP network address prefix
